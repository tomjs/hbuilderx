...
打开本示例目录 `examples/ext-web-vue-multiple` ，执行如下命令编译代码
...
- 将当前示例 `examples/ext-web-vue-multiple` 拖拽到 `HBuilderX` 中
- 点击左上 `运行` 图标，选择点击 `运行插件-[ext-web-vue-multiple]` 或 `调试插件-[ext-web-vue-multiple]`，会打开的 `HBuilderX` 窗口调试插件。
